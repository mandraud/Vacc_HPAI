...
La base de données MEP définie ci-dessous référence le nombre quotidien de lots mis en place sur la période d'étude.  
...
Le modèle est sourcé à partir du fichier "Vaccination_Chair.R". Il prend en compte les dynamiques de population décrites ci-dessus, intégrant directement les données de Mises En Place (MEP) et les distributions de durées d'élevage. 
Les temporalités de différentes phases de vaccination sont définies à partir des protocoles théoriques. La première visite est définie entre 10 et 21 jours d'âge avec une probabilité uniforme entre 10 et 15 jours plus élevée que sur la période suivante (jusqu'à 21 jours), reflétant les données observées sur le terrain. La seconde vaccination doit avoir lieu au plus tard 23 jours après la première. Une fenètre de temps entre 18 et 23 jours est prise en compte. 

Le modèle résulte en une list de deux outputs: les sorties brutes et le graphique associé. 
...
Le modèle est sourcé à partir du fichier "Vaccination_gras.R". Il prend en compte les dynamiques de population décrites ci-dessus, intégrant directement les données de Mises En Place (MEP) et les distributions de durées d'élevage. 
Les temporalités de différentes phases de vaccination sont définies à partir des protocoles théoriques. La première visite est définie entre 10 et 21 jours d'âge avec une probabilité uniforme entre 10 et 15 jours plus élevée que sur la période suivante (jusqu'à 21 jours), reflétant les données observées sur le terrain. La seconde vaccination doit avoir lieu au plus tard 23 jours après la première. Une fenètre de temps entre 18 et 23 jours est prise en compte. 
